...
import 'package:flutter_generator/src/classdiagram/class_generator.dart';
...
class ClassDiagramBuilder implements Builder {
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    final content = await MermaidClassDiagramGenerator(includePrivate).generate(reader, buildStep);
